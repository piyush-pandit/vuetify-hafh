  ...
  <div>
    <v-card>
      ...
      <v-list-item>
        ...
        <v-list>
          <v-btn outlined rounded color="#ffab01" dark small> Add to Old </v-btn><br />
          <v-btn outlined rounded color="#ffab01" dark small> Delete Old </v-btn>
          <v-btn outlined rounded color="#ffab01" dark small> post this </v-btn>
        </v-list> 
        </v-menu>
      </v-list-item>
